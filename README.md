...
[Live Demo](https://image-gallery.eugene-grebennikov.pro/)
...
```bash
git clone https://github.com/DjonnyX/ng-virtual-list-image-gallery.git
cd ng-virtual-list-image-gallery
```
